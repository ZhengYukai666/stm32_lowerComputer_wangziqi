...
#define READ_SDA2   PBin(5)  //输入SDA 
#define IIC_SDA3    PBout(1) //SDA	 
#define READ_SDA3   PBin(1)  //输入SDA 
#define IIC_SDA4    PBout(0) //SDA	 
#define READ_SDA4   PBin(0)  //输入SDA 
#define IIC_SDA5    PBout(2) //SDA	 
#define READ_SDA5   PBin(2)  //输入SDA 
	
//IIC所有操作函数
void IIC_Init(void);                //初始化IIC的IO口				 
void IIC_Start(void);				//发送IIC开始信号
void IIC_Stop(void);	  			//发送IIC停止信号
void IIC_Send_Byte(u8 txd,u8 txd2,u8 txd3);			//IIC发送一个字节
